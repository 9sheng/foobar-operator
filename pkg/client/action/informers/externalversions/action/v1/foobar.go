...
import (
	...
	versioned "github.com/9sheng/foobar-operator/pkg/client/action/clientset/versioned"
	internalinterfaces "github.com/9sheng/foobar-operator/pkg/client/action/informers/externalversions/internalinterfaces"
	v1 "github.com/9sheng/foobar-operator/pkg/client/action/listers/action/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TestV1().FooBars(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestV1().FooBars(namespace).Watch(options)
			},
		},
		&actionv1.FooBar{},
		resyncPeriod,
...
func (f *fooBarInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&actionv1.FooBar{}, f.defaultInformer)
}
