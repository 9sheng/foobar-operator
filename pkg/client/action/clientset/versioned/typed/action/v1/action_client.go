...
import (
	...
	"github.com/9sheng/foobar-operator/pkg/client/action/clientset/versioned/scheme"
...
// TestV1Client is used to interact with features provided by the test.example.com group.
type TestV1Client struct {
	restClient rest.Interface
}

func (c *TestV1Client) FooBars(namespace string) FooBarInterface {
